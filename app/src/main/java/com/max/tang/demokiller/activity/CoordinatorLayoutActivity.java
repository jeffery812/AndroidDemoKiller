...
public class CoordinatorLayoutActivity extends AppCompatActivity {
    ...
    @BindView(R.id.main_iv_placeholder) ImageView mIvPlaceholder; // 大图片

    @BindView(R.id.main_ll_title_container) LinearLayout mLlTitleContainer; // Title的LinearLayout

    @BindView(R.id.main_fl_title) FrameLayout mFlTitleContainer; // Title的FrameLayout

    @BindView(R.id.main_abl_app_bar) AppBarLayout mAblAppBar; // 整个可以滑动的AppBar

    @BindView(R.id.main_tv_toolbar_title) TextView mTvToolbarTitle; // 标题栏Title

    //@BindView(R.id.main_tb_toolbar) Toolbar mTbToolbar; // 工具栏
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        mAblAppBar.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                Logger.d("CoordinatorLayout percent: " + percentage);
            }
        });
