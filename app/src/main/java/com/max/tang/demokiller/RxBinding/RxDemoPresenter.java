...
public class RxDemoPresenter implements DeviceContract.Presenter {
    ...
    @Override public List<DeviceInfo> getData() {
        ...
        data.add(new DeviceInfo("Mobile Rx(KB)", String.valueOf(TrafficStats.getMobileRxBytes()/1024)));
        data.add(new DeviceInfo("Mobile Tx(KB)", String.valueOf(TrafficStats.getMobileTxBytes()/1024)));
        data.add(new DeviceInfo("Total Rx(KB)", String.valueOf(TrafficStats.getTotalRxBytes()/1024)));
        data.add(new DeviceInfo("Total Tx(KB)", String.valueOf(TrafficStats.getTotalTxBytes()/1024)));
        return data;
    }
